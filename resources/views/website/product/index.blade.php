                ...
                <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                    <div class="product-image">
                        <div class="product_img_box">
                            <img id="product_img" src="{{ asset($product->image) }}" data-zoom-image="{{ asset($product->image) }}" alt="product_img1" />
                        ...
                        <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                            <div class="item">
                                <a href="#" class="product_gallery_item active" data-image="{{ asset($product->image) }}" data-zoom-image="{{ asset($product->image) }}">
                                    <img src="{{ asset($product->image) }}" alt="product_small_img1" />
                                </a>
                            </div>
                            @foreach($product->productSubImages as $productSubImage)
                            <div class="item">
                                <a href="#" class="product_gallery_item" data-image="{{ asset($productSubImage->image) }}" data-zoom-image="{{ $productSubImage->image }}">
                                    <img src="{{ asset($productSubImage->image) }}" alt="product_small_img2" />
                                </a>
                            </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="pr_detail">
                        <div class="product_description">
                            ...
                            <div class="product_price">
                                @if(isset($discount->discount_amount))
                                    <span class="price">${{ round(($product->selling_price * $discount->discount_amount)/100) }}</span>
                            ...
                            <div class="pr_switch_wrap">
                                ...
                                <div class="product_color_switch">
                                    @foreach($product->colors as $key => $productColor)
                                        <label><input type="radio" {{ $key == 0 ? 'checked' : '' }} name="color" value="{{ $productColor->color->name }}"> {{ $productColor->color->name }}</label>
                                    @endforeach
                                </div>
                            </div>
                            <div class="pr_switch_wrap">
                                ...
                                <div class="product_size_switch">
                                    <select name="size" style="width: 100px">
                                        @foreach($product->sizes as $keySize => $productSize)
                                            <option value="{{$productSize->size->name}}" {{$keySize == 0 ? 'selected' : ''}}>{{$productSize->size->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <ul class="product-meta">
                            <li>SKU: <a href="#">{{ $product->code }}</a></li>
                        ...
                        <div class="tab-content shop_info_tab">
                            ...
                            <div class="tab-pane fade" id="Additional-info" role="tabpanel" aria-labelledby="Additional-info-tab">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>Color</td>
                                        <td>@foreach($product->colors as $productColor) {{$productColor->color->name.', '}} @endforeach</td>
                                    </tr>
                                    <tr>
                                        <td>Total Sales</td>
