        ...
        <div class="d-flex">
            ...
            @if(Session::get('vendor_id'))
                ...
                <a class="logo-horizontal " href="{{ route('vendor.dashboard') }}">
                    <img src="{{ asset('/') }}website/assets/images/logo_light.png" class="header-brand-img desktop-logo" alt="logo">
                    <img src="{{ asset('/') }}website/assets/images/logo_dark.png" class="header-brand-img light-logo1"
                         alt="logo">
                </a>
            @else
                <!-- sidebar-toggle-->
