    ...
    <table cellpadding="0" cellspacing="0">
            ...
            <td colspan="4">
                <table>
                    <tr>
                        <td class="title">
                            <img
                                src="{{ asset('/') }}website/assets/images/logo_dark.png"
        ...
        @foreach($order->orderDetails as $orderDetail)
            <tr class="item">
                ...
                <td align="right">${{ $total = $orderDetail->product_price * $orderDetail->product_qty }}</td>
            </tr>
            @php($sum = $sum + $total)
        @endforeach
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td align="right">Total Payable: ${{ round($sum + $tax + $shipping) }}</td>
        </tr>
    </table>
</div>
</body>
