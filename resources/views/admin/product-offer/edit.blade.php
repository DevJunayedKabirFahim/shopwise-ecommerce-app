        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Edit Offer Form</h3>
                    <a href="{{ route('product-offer.index') }}" class="btn btn-primary-gradient ms-auto">Manage Product Offer</a>
                </div>
                <div class="card-body">
                    <p class="text-success">{{ session('message') }}</p>
                    <form class="form-horizontal" method="post" action="{{ route('product-offer.update', $productOffer->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9 form-group">
                                <select name="product_id" class="form-control select2-show-search form-select w-100" data-placeholder="Choose any Product">
                                    ...
                                    @foreach($products as $product)
                                        <option value="{{ $product->id }}" @selected($productOffer->product_id == $product->id)>{{ $product->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="title_one" value="{{ $productOffer->title_one }}" placeholder="Enter first title of banner"/>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="title_two" value="{{ $productOffer->title_two }}" placeholder="Enter Second title of banner"/>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <div class="card card-body">
                                    <textarea class="content" name="description">{{ $productOffer->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="discount_amount" value="{{ $productOffer->discount_amount }}" name="discount_amount" placeholder="Enter Discount amount"/>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-12 col-md-5 mg-t-10 mg-sm-t-0">
                                ...
                                <img src="{{ asset($productOffer->image) }}" alt="" height="120" width="150">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pt-3">
                                <label><input name="status" type="radio" {{ $productOffer->status == 1 ? 'checked' : '' }}  value="1"> <span>Published</span></label>
                                <label><input name="status" type="radio" {{ $productOffer->status == 0 ? 'checked' : '' }} value="0"> <span>Unpublished</span></label>
                            </div>
                            <div class="col-md-3 pt-3">
                        ...
                        <button class="btn btn-primary float-end" type="submit">Update Offer Info</button>
                    </form>
                </div>
            </div>
        </div>
