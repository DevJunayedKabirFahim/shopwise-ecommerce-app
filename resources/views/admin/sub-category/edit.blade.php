        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('sub-category.update', $sub_category->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <span class="text-white bg-danger">{{ $errors->has('category_id') ? $errors->first('category_id') : ''}}</span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="name" class="col-md-3 form-label">Subcategory Name</label>
                            <div class="col-md-9">
                                <input class="form-control" id="name" name="name" value="{{ $sub_category->name }}" placeholder="Enter Subcategory Name" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="description" name="description" value="{{ $sub_category->description }}" placeholder="Enter category description" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-12 col-md-5 mg-t-10 mg-sm-t-0">
                                ...
                                <img src="{{ asset($sub_category->image) }}" alt="" height="120" width="130"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pt-3">
                                <label><input name="status" type="radio" {{ $sub_category->status == 1 ? 'checked' : '' }} value="1"> <span>Published</span></label>
                                <label><input name="status" type="radio" {{ $sub_category->status == 0 ? 'checked' : '' }} value="0"> <span>Unpublished</span></label>
                            </div>
                            <div class="col-md-3 pt-3">
                        ...
                        <button class="btn btn-primary float-end" type="submit">Update subcategory</button>
                    </form>
                </div>
            </div>
        </div>
