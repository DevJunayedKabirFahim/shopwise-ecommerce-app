                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('sub-category.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Subcategory Name" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" maxlength="225"  name="description" id="description" placeholder="Enter subcategory description" rows="3">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
