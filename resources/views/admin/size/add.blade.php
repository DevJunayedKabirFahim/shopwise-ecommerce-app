                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('size.store') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Size Name" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="code" name="code" value="{{ old('name') }}" placeholder="Enter Size code" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" maxlength="225"  name="description" id="description" placeholder="Enter size description" rows="3">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        {{--<div class="row mb-4">
                        ...
                        <button class="btn btn-primary float-end" type="submit">Create new Size</button>
                    </form>
                </div>
            </div>
        </div>
